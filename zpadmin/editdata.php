					...
					if ($result-> num_rows >0) {
						...
						while ($row= $result-> fetch_assoc()) {
							...
							<tr><td><?php echo $row['slno']; ?></td><td><?php echo $row['project_name']; ?></td>
								<td><input type="Number" value="<?php echo "".$row['rem_processing']."" ?>" name="rem_processing[<?php echo $i; ?>]" required="" id="rem_processing[<?php echo $i; ?>]"></td>
								<td><input type="Number" value="<?php echo "".$row['cur_processing']."" ?>" name="rem_processing[<?php echo $i; ?>]" required="" id="cur_processing[<?php echo $i; ?>]"></td>
								<td><input type="Number" value="<?php echo "".$row['rem_completed']."" ?>" name="rem_processing[<?php echo $i; ?>]" required="" id="rem_completed[<?php echo $i; ?>]"></td>
								<td><input type="Number" value="<?php echo "".$row['cur_completed']."" ?>" name="rem_processing[<?php echo $i; ?>]" required="" id="cur_completed[<?php echo $i; ?>]"></td>
							</tr>
							<?php
							$i++;
						}
