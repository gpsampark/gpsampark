...
<html>
<head>
  <title>Gramsampark | View District report</title>
</head>
  ...
  <body class="bg">
    ...
    <div class="container-fluid">
      <div class="container" style="border:solid thin black;border-radius: 10px;">
        <form  class="form-horizontal w3-animate-zoom" action="viewdistrictreport.php" method="POST">

        <h2 class="well well-sm" style="background-color:transparent; animation-duration: 3s;text-shadow:1px 1px 0 #444;text-align: center;"><b>MONTHLY DISTRICT EXPENDITURE</b></h2><br>
